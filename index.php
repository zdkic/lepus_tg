...
<hr>
    ...
    <div class="controls">
        <select name="smstype" id="smstype" class="input-medium" onchange="update(this.value)">
         <option value="fetion" <?php echo set_selected('fetion',$settings['smstype']) ?>>Fetion</option>
         <option value="api" <?php echo set_selected('api',$settings['smstype']) ?>>Telegram</option>
        </select>
    </div>
   </div>
   ...
   <div id="telegram_panel">
    <div class="control-group info" >
      <label class="control-label" for="">*<?php echo $this->lang->line('telegram_bot_token'); ?></label>
      <div class="controls">
        <input type="text" id="sms_telegram_bot_token"  name="sms_telegram_bot_token" value="<?php echo $settings['sms_telegram_bot_token'] ?>" class="input-large">
      </div>
    </div>
    <div class="control-group info" >
      <label class="control-label" for="">*<?php echo $this->lang->line('telegram_chat_id'); ?></label>
      <div class="controls">
        <input type="text" id="sms_telegram_chat_id"  name="sms_telegram_chat_id" value="<?php echo $settings['sms_telegram_chat_id'] ?>" class="input-large">
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  function init() {
    var smstype = "<?php echo $settings['smstype']; ?>";
    update(smstype);
  }
  function update(smstype)
  {
    if(smstype == "fetion") {
        document.getElementById("fetion_panel").style.display = 'block';
        document.getElementById("telegram_panel").style.display = 'none';
    } else {
        document.getElementById("fetion_panel").style.display = 'none';
        document.getElementById("telegram_panel").style.display = 'block';
    }
  }
  init();
</script>
